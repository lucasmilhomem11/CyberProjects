...
#   print("\nThis little project will check if your password has eve been breached!\n")
#   num_passwords = int(input("How many passwords would you like to check? "))

#   for i in range(1, num_passwords + 1):
#       password = maskpass.askpass(prompt=f"Attempt {i} - Please enter your password, it will be masked and nobody will see:\n",mask="*")
#       # break
...
#           safe_password = False
#           # print("Type in 'done' when there is no other password to check.\n")
